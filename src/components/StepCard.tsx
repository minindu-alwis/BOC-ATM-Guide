    ...
    <div className="w-full bg-white rounded-lg shadow-md overflow-hidden transition-all duration-500 animate-fade-in">
      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row gap-6 items-center">
          {/* Animation container with much larger size on mobile */}
          <div className="flex-shrink-0 w-full h-80 md:w-48 md:h-48 bg-gray-100 rounded-lg flex items-center justify-center">
