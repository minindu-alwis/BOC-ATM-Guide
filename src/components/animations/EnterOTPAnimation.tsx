...
const EnterOTPAnimation: React.FC<AnimationProps> = ({ darkMode }) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (currentIndex < numbers.length) {
        ...
        setOTP(prev => prev + numbers[currentIndex]);
...
export default EnterOTPAnimation;